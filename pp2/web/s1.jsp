...
PreparedStatement    p=con.prepareStatement("SELECT distinct(company_name) from company , ys where company.rate1 between 1 and ys.rate1 or company.rate2 between 1 and ys.rate2  and ys.name=?");
p.setString(1,name);
...
<!--<tr bgcolor="#DEB887">
    ...
    <td><%=resultSet.getString("company_name") %><br></td>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
          ...
          <p class="title"><h4><%=resultSet.getString("website") %></h4></p><br>
      </div>
    </div>
...
<br>
<center><h1>Apply to</h1></center>
<div class="sagar">
<form action="s2" method="post">
    <center><input type="text" name="apply"></center><br>
